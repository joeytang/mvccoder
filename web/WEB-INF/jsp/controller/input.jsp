	...
	$('#inputForm').ajaxForm({
		...
		success : function(data){
			$.parseJsonResult(data,function(data){
				$.info("操作成功");
				$("#mainDiv").renderUrl("${ctx}/controller/main");
			},function(msg,data){
...
<form  class="form" id="inputForm" method="post" action="${ctx }/controller/save" >
	<input type="hidden" name="id" id="idId" value="${controller.id}" />
	<table class="form-table" cellpadding="0" cellspacing="0">
		<tr> 
	      <td class="righttd">方法名:</td>
	      <td class="lefttd"  style="width:300px" >
			<input class="input" style="width:280px;height:20px;" type="text" name="name" id="nameId" maxlength="100" value="${controller.name}"/>
	      </td>
		...
		<tr> 
	      ...
	      <input type="button" id="backToListBtn" onclick='javascript:$("#mainDiv").renderUrl("${ctx}/controller/main");' value="返回列表" />
	      </td>
	    </tr>
	</table>
</form>