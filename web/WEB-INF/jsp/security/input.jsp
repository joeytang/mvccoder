	...
	$('#inputForm').ajaxForm({
		...
		success : function(data){
			$.parseJsonResult(data,function(data){
				$.info("操作成功");
				$("#mainDiv").renderUrl("${ctx}/security/main");
			},function(msg,data){
...
<form  class="form" id="inputForm" method="post" action="${ctx }/security/save" >
	<input type="hidden" name="id" id="idId" value="${security.id}" />
	<table class="form-table" cellpadding="0" cellspacing="0">
		...
		<tr> 
	      ...
	      <input type="button" id="backToListBtn" onclick='javascript:$("#mainDiv").renderUrl("${ctx}/security/main");' value="返回列表" />
	      </td>
	    </tr>
	</table>
</form>