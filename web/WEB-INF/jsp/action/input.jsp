	...
	$('#inputForm').ajaxForm({
		...
		success : function(data){
			$.parseJsonResult(data,function(data){
				$.info("操作成功");
				$("#mainDiv").renderUrl("${ctx}/action/main");
			},function(msg,data){
...
<form  class="form" id="inputForm" method="post" action="${ctx }/action/save" >
	<input type="hidden" name="id" id="idId" value="${action.id}" />
	<table class="form-table" cellpadding="0" cellspacing="0">
		...
		<tr> 
	      ...
	      <input type="button" id="backToListBtn" onclick='javascript:$("#mainDiv").renderUrl("${ctx}/action/main");' value="返回列表" />
	      </td>
	    </tr>
	</table>
</form>