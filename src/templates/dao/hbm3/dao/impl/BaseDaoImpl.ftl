package ${project.org}.common.dao.impl;
...
import ${project.org}.common.dao.criteria.HqlInBean;
import ${project.org}.common.dao.SqlSort;
import ${project.org}.common.dao.SqlFilter;
import ${project.org}.common.dao.criteria.SqlSortAdapter;
import ${project.org}.common.dao.criteria.SqlFilterAdapter;
...
public class BaseDaoImpl<T, PK extends Serializable> extends HibernateDaoSupport implements BaseDao<T,PK> {
    ...
    public T save(T entity) {
    	...
    	PK id = (PK) super.getHibernateTemplate().save(entity);
    	return this.get(id); 
