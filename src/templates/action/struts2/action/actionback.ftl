package ${domain.domainPackage}.web.action.back;
...
import ${project.org}.security.web.action.BaseBackAction;
 ...
 * "${domain.domainCnName}"模块后台action
 */
@Controller("back${domain.domainName}Action")
@Scope("prototype")
public class ${domain.domainName}Action extends BaseBackAction implements ModelDriven<${domain.domainName}>, Preparable {
